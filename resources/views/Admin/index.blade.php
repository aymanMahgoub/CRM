          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="{{route('admin')}}" class="btn btn-default btn-flat">Home</a>
                </div>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('admin.employee')}}"><i class="fa fa-circle-o"></i>All Employee</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('admin.customer')}}"><i class="fa fa-circle-o"></i>All Customers</a></li>
