...
angular
  .module('app', ['flexcalendar1', 'pascalprecht.translate'])
...
! function() {
  ...
  angular.module("flexcalendar1", []).directive("flexCalendar1", e), t.$inject = ["$scope", "$filter"]
}();